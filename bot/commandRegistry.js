const commands = [
  ...
  { name: 'starter_kit', aliases: ['tj kit', 'tj restock', 'tj restock kit', 'tj starter kit', 'tj gear me up', 'tj give kit', 'tj outfit me'], category: 'core', ownerOnly: true, requiresConfirmation: false, action: 'applyStarterKit', implemented: true, description: 'Gives iron-and-below tools, armor, and building blocks (local op /give).' },
  ...
  { name: 'suggest_next_skill', aliases: ['tj suggest next skill', 'tj suggest skills', 'tj what can you practice', 'tj what should you practice', 'tj progress', 'tj achievements', 'tj what needs work'], category: 'debug', ownerOnly: true, requiresConfirmation: false, action: 'suggestNextSkill', implemented: false, description: 'Retired with the curriculum/progression system; retained as a friendly compatibility alias.' },
  ...
  { name: 'water_rescue', aliases: ['tj get to shore', 'tj swim to shore', 'tj get out of water', 'tj water rescue'], category: 'movement', ownerOnly: true, requiresConfirmation: false, action: 'waterRescue', implemented: true, description: 'Immediately surfaces and moves toward the nearest bounded safe exit.' },
  ...
  { name: 'finish_last_job', aliases: ['tj finish last job', 'tj finish current job', 'tj finish curretn job', 'tj continue mining', 'tj resume collection', 'tj finish job'], category: 'thin_core', ownerOnly: true, requiresConfirmation: false, action: 'resume_last_collect', implemented: true, description: 'Resumes the last incomplete wood/stone/coal/iron collect job.' },
  ...
  { name: 'smelt_item', aliases: ['tj smelt ore'], category: 'crafting', ownerOnly: true, requiresConfirmation: false, action: 'smelt_item', implemented: true, description: 'Smelts a supported item using a furnace.' },
  { name: 'smelt_iron', aliases: ['tj smelt iron', 'tj smelt raw iron'], category: 'crafting', ownerOnly: true, requiresConfirmation: false, action: 'smelt_iron', implemented: true, description: 'Smelts raw iron or iron ore into ingots.' },
  { name: 'smelt_charcoal', aliases: ['tj smelt charcoal', 'tj make charcoal'], category: 'crafting', ownerOnly: true, requiresConfirmation: false, action: 'smelt_charcoal', implemented: true, description: 'Smelts logs into charcoal.' },
  ...
  { name: 'store_items', aliases: ['tj store items', 'tj deposit items', 'tj deposit inventory', 'tj store inventory', 'tj put stuff away', 'tj put items away'], category: 'storage', ownerOnly: true, requiresConfirmation: false, action: 'store_items', implemented: true, description: 'Stores excess items in registered storage.' },
  ...
  { name: 'scan_area', aliases: ['tj scan area', 'tj look around', 'tj what can you see'], category: 'exploration', ownerOnly: true, requiresConfirmation: false, action: 'scan_area', implemented: true, description: 'Scans visible nearby resources, landmarks, and dangers.' },
  ...
  { name: 'progress_to_iron', aliases: ['tj progress to iron', 'tj progress_to_iron', 'tj iron age', 'tj run core progress to iron', 'tj run progress to iron', 'tj to iron'], category: 'core', ownerOnly: true, requiresConfirmation: false, action: 'run_core_macro', implemented: true, description: 'Runs the full surface progression macro to iron tools (wood → stone → fuel → iron → tools).' },
  ...
  { name: 'companion_mode', aliases: ['tj companion mode', 'tj player 2 mode', 'tj coop mode', 'tj co op mode'], category: 'core', ownerOnly: true, requiresConfirmation: false, action: 'companionMode', implemented: true, description: 'Living Player 2 mode: soft follow, task narration, stuck recovery, grounded ambient chat.' },
  ...
  { name: 'fish_for_food', aliases: ['tj fish for food', 'tj fish', 'tj keep fishing', 'tj start fishing', 'tj fish until i say stop'], category: 'food', ownerOnly: true, requiresConfirmation: false, action: 'fish_for_food', implemented: true, description: 'Keeps fishing beside safe open water until the owner says stop.' },
...
commands.push(
  ...
  { name: 'goal_explanation', aliases: ['tj goal', 'tj current goal', 'tj what is your goal?', 'tj what is your goal', 'tj what is your current goal', "tj what's your current goal", 'tj whats your current goal', 'tj what are you working on?', 'tj what are you working on', 'tj what are you doing?', 'tj what are you doing', 'tj explain goal', 'tj explain plan', 'tj goal progress'], category: 'goals', ownerOnly: true, requiresConfirmation: false, action: 'explainGoal', implemented: true, description: 'Explains the active goal or current plan.' },
  ...
  { name: 'planner_next', aliases: ['tj what should we do next?', 'tj what do we need?', 'tj what do we need', 'tj what are we missing?', 'tj what are we missing', 'tj what is the smartest next move?', 'tj what is the smartest next move', 'tj what should you work on?', 'tj what should you work on', 'tj how can we improve the base?', 'tj how can we improve the base'], category: 'goals', ownerOnly: true, requiresConfirmation: false, action: 'plannerSuggestNext', implemented: true, description: 'Suggests a safe next goal or improvement.' },
...
const commandAliasPatches = {
  ...
  fish_for_food: ['fish', 'keep fishing', 'start fishing', 'fish until i say stop'],
